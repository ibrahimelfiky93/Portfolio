...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function setTheme(theme) {
    if (theme === "light") {
      ...
      root.style.setProperty("--shadow-sm", "rgba(0, 0, 0, 0.075)");
      root.style.setProperty("--shadow-lg", "rgba(0, 0, 0, 0.175)");
      ...
      root.style.setProperty("--shadow", "rgba(180, 180, 180, 0.15)");
      root.style.setProperty("--shadow-sm", "rgba(180, 180, 180, 0.075)");
      root.style.setProperty("--shadow-lg", "rgba(180, 180, 180, 0.175)");
